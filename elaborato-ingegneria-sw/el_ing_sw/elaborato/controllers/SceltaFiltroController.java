...
public class SceltaFiltroController implements Initializable {
	@FXML
	...
	/*
	 * private AutomunitoFilter filtro_af; private DisponibilitaComuneFilter
	 * filtro_dcf; private DisponibilitaDataFilter filtro_ddf; private
	 * LavoratoreFilter filtro_laf; private LinguaFilter filtro_lf; private
	 * PatenteFilter filtro_pf; private SpecializzazioneFilter filtro_sf;
	 */
	...
	public void visiona_finestra_filtro_oa(ActionEvent event) throws IOException {
		...
		case "specializzazione":
			...
			SpecializzazioneController sp_controller = loader.getController();
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		tipi_filtro.getItems().addAll("automunito", "comune", "disponibilita", "lavoratore", "lingua", "patente",
				"specializzazione"); // manca SPECIALIZZAZIONE!!
		// tipi_filtro.getItems().addAll(filtro_af.getNameFilter(),filtro_dcf.getNameFilter(),filtro_ddf.getNameFilter(),filtro_laf.getNameFilter(),filtro_lf.getNameFilter(),filtro_pf.getNameFilter(),filtro_sf.getNameFilter());
		// //dovrei inizializzarlo chiamando getNameFilter
