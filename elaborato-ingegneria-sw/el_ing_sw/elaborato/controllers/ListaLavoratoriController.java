...
public class ListaLavoratoriController implements Initializable {
	...
	public Stage showEditLavoratore(int lavoratoreId) {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/elaborato/FXML/EditLavoratore.fxml"));
		...
		try {
			...
			EditLavoratoreController controller = loader.getController();
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		luogo_di_nascita
				.setCellValueFactory(anagLav -> new SimpleStringProperty(anagLav.getValue().getLuogo_di_nascita()));
		...
		automunito.setCellValueFactory(
				anagLav -> new SimpleStringProperty(anagLav.getValue().isAutomunito() ? "✓" : "×"));
