...
public class EditLavoratoreController implements Initializable {
	...
	public void validateFields() throws Exception {
		...
		// RFC 5322
		if (!Pattern.compile("^[a-zA-Z0-9_!#$%&’*+/=?`{|}~^.-]+@[a-zA-Z0-9.-]+$").matcher(email_em_tf.getText())
				.matches()
				|| !Pattern.compile("^[a-zA-Z0-9_!#$%&’*+/=?`{|}~^.-]+@[a-zA-Z0-9.-]+$").matcher(email_tf.getText())
						.matches()) {
