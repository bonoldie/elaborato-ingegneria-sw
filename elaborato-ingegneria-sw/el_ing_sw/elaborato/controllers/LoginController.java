...
public class LoginController {
	...
	@FXML
	private void controllo_credenziali(ActionEvent event)
		...
		byte[] hashedPasswd = MessageDigest.getInstance("SHA-256")
				.digest(password.getText().getBytes(StandardCharsets.UTF_8));
