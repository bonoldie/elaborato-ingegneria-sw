...
public class periodo_controller implements Initializable{
	@FXML
	...
	public void getperiodo_oa(ActionEvent event) { //da completare
		...
		//
		//chiusura
		DisponibilitaDataFilter f= new DisponibilitaDataFilter(data_if.getSelectionModel().getSelectedItem(),operatore.getSelectionModel().getSelectedItem());
